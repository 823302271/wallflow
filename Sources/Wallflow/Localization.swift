...
enum L10n {
    enum Key: String {
        ...
        case libraryColumnDisplays = "library.column.displays"
        case libraryColumnSource = "library.column.source"
        case libraryApplyTo = "library.apply_to"
        case libraryApplyAllDisplays = "library.apply_all_displays"
        case libraryDisplayIndex = "library.display_index"
        case multiDisplayWallpapers = "menu.multi_display_wallpapers"
        ...
        case libraryImportEnginePack = "library.import_engine_pack"
        case libraryEnginePackInstalled = "library.engine_pack_installed"
        case libraryEnginePackMissing = "library.engine_pack_missing"
        case libraryEnginePackTitle = "library.engine_pack_title"
        case libraryEnginePackMessage = "library.engine_pack_message"
